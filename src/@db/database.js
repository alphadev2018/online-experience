...
export const iconicBuildingInfo = window.videos ? window.videos : {	
	"hot_EMEA": {
		index: 'rpbxyy3m64',
		padding: '56.25%',
		title: 'Building Nightingale'
	},
	"hot2_EMEA": {
		index: '55ks5vhfck',
		padding: '44.17%',
		title: 'Rising to the challenge: Afsluitdijk'
	},
	"hot_AMERICA": {
		index: 'f7isl7k129',
		padding: '56.25%',
		title: 'Reimagine Sustainability: The Kendeda Story'
	},
	"hot_APAC": {
		index: 'ox9vfq0kuu',
		padding: '56.25%',
		title: 'Building an Icon: The Coliseum'
	}
}
